...
This respository contains previous final projects by your classmates. Feel free to browse their projects! Below, you'll see an example final project for you to be inspired by. You can download this file or the template file at the bottom. 
...
Download [this Rmd file](https://github.com/matthewhirschey/tidybiology-final_project/blob/master/final_project.Rmd) or [the template](https://github.com/matthewhirschey/tidybiology-final_project/blob/master/final_project_template.Rmd)